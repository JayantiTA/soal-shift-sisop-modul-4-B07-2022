...
Pada implementasi rename, string path yang lama akan didecode satu string penuh sedangkan untuk string path baru hanya akan didecode lokasi file atau folder sehingga nama file atau folder yang baru pada string path baru tidak akan didecode. Kemudian bila terdapat perubahan nama "Animeku\_" akan dicatat di dalam log wibu.
